...
class Magetools_Cache_Disable extends Magetools_Cache_Abstract
{
    ...
    protected function _process()
    {
        ...
        if ($this->_getOpt('all', false)) {
            ...
            $this->_printMessage('All types of cache were disabled.');
        } else {
            ...
            if ($type) {
                ...
                $str .= 'You don\'t set any specific params. Please, select one or few (by comma ",")'
                    . PHP_EOL . 'types of cache for disabling (press Enter to select all):';
                ...
                foreach ($choice as $key) {
                    $clean[$this->_choiceNumbers[$key]] = 0;
                }
            }
            ...
            if ($clean) {
                ...
                $this->_printMessage(sprintf(
                    'Following cache types "%s" were disabled.',
